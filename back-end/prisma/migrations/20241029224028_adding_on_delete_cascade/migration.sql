...
-- DropForeignKey
ALTER TABLE "Post" DROP CONSTRAINT "Post_decisionMakerId_fkey";

-- DropForeignKey
ALTER TABLE "Post" DROP CONSTRAINT "Post_higherOrgId_fkey";

-- DropForeignKey
ALTER TABLE "Post" DROP CONSTRAINT "Post_orgMemberId_fkey";
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_orgMemberId_fkey" FOREIGN KEY ("orgMemberId") REFERENCES "OrganizationMember"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_higherOrgId_fkey" FOREIGN KEY ("higherOrgId") REFERENCES "HighLevelOrganization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_decisionMakerId_fkey" FOREIGN KEY ("decisionMakerId") REFERENCES "DecisionMaker"("id") ON DELETE CASCADE ON UPDATE CASCADE;
